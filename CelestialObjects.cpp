...
CelestialObjects::CelestialObjects()
{
	...
	Game::checkInitialized(objectSprite[GALAXY_1].bitmap, "dat/gfx/galaxy1.png");
	...
	Game::checkInitialized(objectSprite[GALAXY_2].bitmap, "dat/gfx/galaxy2.png");
	...
	Game::checkInitialized(objectSprite[GALAXY_3].bitmap, "dat/gfx/galaxy3.png");
	...
	Game::checkInitialized(objectSprite[GALAXY_4].bitmap, "dat/gfx/galaxy4.png");
	...
	Game::checkInitialized(objectSprite[MOON_1].bitmap, "dat/gfx/moon1.png");
	...
	Game::checkInitialized(objectSprite[MOON_2].bitmap, "dat/gfx/moon2.png");
	...
	Game::checkInitialized(objectSprite[PLANET_1].bitmap, "dat/gfx/planet1.png");
	...
	Game::checkInitialized(objectSprite[PLANET_2].bitmap, "dat/gfx/planet2.png");
	...
	Game::checkInitialized(objectSprite[PLANET_3].bitmap, "dat/gfx/planet3.png");
	...
	Game::checkInitialized(objectSprite[PLANET_4].bitmap, "dat/gfx/planet4.png");
	...
	{
		object[i].y = Game::between(-(float)maxSpriteHeight, (float)bufferHeight + (float)maxSpriteHeight);
...
void CelestialObjects::draw()
{
	...
	for (int i = 0; i < objectCount; i++)
	{
		...
		else
		{
			...
			if (object[i].y >= 0 && object[i].y <= bufferHeight) al_draw_pixel(objectX, object[i].y, al_map_rgb_f(l + Game::between(0.0f, 0.3f), l + Game::between(0.0f, 0.3f), l + Game::between(0.0f, 0.3f)));
		}
		objectX += 2;
	}
}
